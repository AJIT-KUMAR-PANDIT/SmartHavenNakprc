    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          {/* Search modal */}
          <motion.div
            className="fixed top-16 left-1/1 w-[95%] md:w-[90%] lg:w-full max-w-2xl -translate-x-1/2 bg-[#1e1e2e] rounded-xl shadow-2xl z-50 border border-gray-700 overflow-hidden mx-auto"
          ...
          >
                ...
                <div key={category} className="mb-4">
                  ...
                  <div className="space-y-1">
                    {results.map((result, index) => {
                      const isActive =
                        searchResults.indexOf(result) === activeIndex;
                      return (
                        <div
                          key={result.id}
            ...
            <div className="p-3 border-t border-gray-700 flex justify-between text-xs text-gray-400">
              <div>
                <span className="inline-block bg-gray-800 rounded px-2 py-1 mr-1">
                  ↑
                </span>
                <span className="inline-block bg-gray-800 rounded px-2 py-1 mr-2">
                  ↓
                </span>
