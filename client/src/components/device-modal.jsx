...
const DeviceModal = ({ isOpen, onClose, onSave, device = null }) => {
  ...
  const validateForm = () => {
    ...
    } else if (isNaN(formData.pin) || Number(formData.pin) < 0 || Number(formData.pin) > 16) {
                ...
                <div className="sm:flex sm:items-start">
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                    ...
                    <div className="mt-6 space-y-4">
                      <div>
                        <label htmlFor="device-name" className="block text-sm font-medium text-gray-400">
                          Device Name
                        </label>
                        <Input
                          id="device-name"
                      ...
                      <div>
                        <label htmlFor="device-route" className="block text-sm font-medium text-gray-400">
                          Device Route
                        </label>
                        <div className="mt-1 flex rounded-md shadow-sm">
                          <Input
                            ...
                            onChange={handleInputChange}
                            className="focus:ring-primary focus:border-primary flex-1 block w-full rounded-md sm:text-sm border-gray-700 bg-[#121218] px-3 py-2"
                          />
                        </div>
                        {errors.route && (
                      ...
                      <div>
                        <label htmlFor="device-type" className="block text-sm font-medium text-gray-400 mb-1">
                          Device Type
                        </label>
                      ...
                      <div>
                        <label htmlFor="device-pin" className="block text-sm font-medium text-gray-400">
                          GPIO Pin
                        </label>
                        <Input
                          type="number"
